...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"显示 _MENU_ 条",sZeroRecords:"查无数据",sEmptyTable:"No data available in table",
    sLoadingRecords: "Loading...", sInfo: "显示 _START_ 至 _END_ 共 _TOTAL_ 条记录", sInfoEmpty: "显示 0 至 0 of 0 条记录", sInfoFiltered: "(从 _MAX_ 条 记录中 过滤)", sInfoPostFix: "", sInfoThousands: ",", sSearch: "查询（支持所有列查询）：", sUrl: "", oPaginate: { sFirst: "第一页", sPrevious: "上一页", sNext: "下一页", sLast: "最后一页" }, fnInfoCallback: null
